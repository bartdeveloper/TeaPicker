...
namespace TeaPicker.Server.Controllers
{
    ...
    public class TeaController : ControllerBase
    {
        private static List<Tea> Teas = new()
        {
            ...
            new() { Id = 4, Name = "Oolong", Description = "Oolong is a partially oxidized tea, placing it somewhere in between black and green teas in terms of oxidation. Oolong teas can range from around 10-80% oxidation, and can brew up anywhere from a pale yellow to a rich amber cup of tea. Many oolongs can be re-infused many times, with subtle differences and nuances of flavor in each successive cup.", BrewingTemp = 95, BrewingTime = 8, ImageUri = "https://www.coffeedesk.pl/blog/wp-content/uploads/2020/05/organic-herbata-zaparzona-1920x1280.jpg" },
            ...
            new() { Id = 9, Name = "Purple", Description = "Purple tea is a relatively new kind of tea, and has only been commercially available for a few years. The tea is produced from a rare purple-leaved tea plant found growing wild in the Assam region of India. Today, purple teas are primarily produced in Kenya, Africa. They have a light body and mellow flavor, and are extremely low in caffeine and high in antioxidants and anthocyanins.", BrewingTemp = 95, BrewingTime = 8, ImageUri = "https://cleanplates.com/wp-content/uploads/what-is-purple-tea-610x310.jpg" }
        };
