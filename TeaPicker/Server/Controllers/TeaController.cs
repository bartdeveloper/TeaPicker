...
namespace TeaPicker.Server.Controllers
{
    ...
    public class TeaController : ControllerBase
    {
        private static List<Tea> Teas = new()
        {
            ...
            new() { Id = 3, Name = "White", Description = "White tea is a delicate, minimally processed tea that is highly sought after by connoisseurs and enjoyed by experts and novices alike. White tea has a light body and a mild flavor with a crisp, clean finish. ", BrewingTemp = 100, BrewingTime = 5, ImageUri = "https://sklep.aspol.info/wp-content/uploads/2021/06/white-tea-47172F.jpg" },
